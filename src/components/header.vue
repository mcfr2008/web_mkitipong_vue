    ...
    <div class="left-header col horizontal-wrapper pl-0">
      <ul class="horizontal-menu">
              ...
              <div class="row">
                ...
                >
                  <div class="mobile-title d-none" v-if="index == 0">
                    <h5>Mega menu</h5>
                    <feather type="x" @click="closeBonusUI"></feather>
                  </div>
                  <div class="link-section" :class="[menuItem.design, { active : menuItem.active }]">
                    <div>
                      <h6 @click="setNavActive(menuItem, index)">{{ menuItem.title }}</h6>
                    </div>
        ...
        <!-- <li class="level-menu outside" @click="openlevelmenu">
          ...
          >
            <li>
              <a href="file-manager.html" title="">
            ...
            <li>
              <a href="#!" title="">
                <feather type="users"></feather><span>Users</span></a
              >
              <ul class="header-level-sub-menu">
                <li>
                  <a href="file-manager.html" title="">
                    <feather type="user"></feather><span>User Profile</span></a
                  >
                </li>
                <li>
                  <a href="file-manager.html" title="">
                ...
                <li>
                  <a href="file-manager.html" title="">
                    ...
                    ><span>Users Cards</span></a
                  >
                </li>
              </ul>
            </li>
            <li>
              <a href="kanban.html" title="">
                <feather type="airplay"></feather><span>Kanban Board</span></a
              >
            </li>
            <li>
              <a href="bookmark.html" title="">
                <feather type="heart"></feather><span>Bookmark</span></a
              >
            </li>
            <li>
              <a href="social-app.html" title="">
                <feather type="zap"></feather><span>Social App </span></a
              >
            </li>
          </ul>
        </li> -->
          ...
          <div class="media profile-media">
            ...
            <div class="media-body">
              ...
              <p class="mb-0 font-roboto">
                {{user.name}} <i class="middle fa fa-angle-down"></i>
              </p>
            </div>
          </div>
